...
export class mongoJsonConverterService {
    ...
    generateSortObject(queryParams: QueryParams) {
        ...
        const direction = queryParams.sortParams.direction === 'descending' ? -1 : 1;
    ...
    generateSkipInt(queryParams: QueryParams) {
        ...
        const numPagesToSkip = queryParams.pageParams.pageNumber ? (queryParams.pageParams.pageNumber - 1) : 0;
        const numDocsToSkip = numPagesToSkip * (queryParams.pageParams.rowsPerPage || 0);
