...
describe('OrgManagementService', () => {
      ...
      it('should rethrow the error generated by the Supabase client when inserting a new database into db_envs', async () => {
        ...
        await service
          .addDb_H1({
            ...
            org_id: '0000',
            type: 'mysql',
            db_info: JSON.stringify({meta: 'data'}),
            host: '127.0.0.1'
          })
          .catch((error) => {
            expect(error).toBeDefined();
  ...
  describe('removeMember', () => {
    ...
    it('should rethrow the error generated by the Supabase client when the user is not logged in', async () => {
      ...
      await service.removeMember({ org_id: '0000', user_id: '0000' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toHaveProperty('message', 'Not logged in');
        expect(error).toHaveProperty('status', 401);
      });
    ...
    it('should throw an UnauthorizedException when the user does not have the required permissions to remove members', async () => {
      ...
      await service.removeMember({ org_id: '0000', user_id: '0000' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toBeInstanceOf(UnauthorizedException);
        expect(error.message).toBe('You do not have permission to remove users');
      });
    })
    ...
    it('should return the removed member data', async () => {
      ...
      const { data } = await service.removeMember({ org_id: '0000', user_id: '0000' });
  ...
  describe('removeDb', () => {
    ...
    it('should rethrow the error generated by the Supabase client when the user is not logged in', async () => {
      ...
      await service.removeDb({ org_id: '0000', db_id: '0000' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toHaveProperty('message', 'Not logged in');
        expect(error).toHaveProperty('status', 401);
      });
    ...
    it('should throw an UnauthorizedException when the user does not have the required permissions to remove databases', async () => {
      ...
      await service.removeDb({ org_id: '0000', db_id: '0000' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toBeInstanceOf(UnauthorizedException);
        expect(error.message).toBe('You do not have permission to remove databases');
      });
    })
    ...
    it('should return the removed database data', async () => {
      ...
      const { data } = await service.removeDb({ org_id: '0000', db_id: '0000' });
  ...
  describe('removeDbAccess', () => {
    ...
    it('should rethrow the error generated by the Supabase client when the user is not logged in', async () => {
      ...
      await service.removeDbAccess({ org_id: '0000', db_id: '0000', user_id: '0000' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toHaveProperty('message', 'Not logged in');
        expect(error).toHaveProperty('status', 401);
      });
    ...
    it('should return the removed database access data', async () => {
      ...
      const { data } = await service.removeDbAccess({ org_id: '0000', db_id: '0000', user_id: '0000' });
