...
describe('OrgManagementService', () => {
  ...
  describe('updateOrg', () => {
    ...
    it('should rethrow the error generated by the Supabase client when the user is not logged in', async () => {
      ...
      service.updateOrg({ org_id: '0000', name: 'TestOrg' }).catch((error) => {
        expect(error).toBeDefined();
        expect(error).toHaveProperty('message', 'Not logged in');
        expect(error).toHaveProperty('status', 401);
      });
  ...
  describe('updateMember', () => {
    ...
    describe('updateMember_H1', () => {
      ...
      it('should set default role permissions when no role permissions are provided', async () => {
        it('should rethrow the error generated by the Supabase client when fetching org member data', async () => {});
        it('should set the default role permissions for the member role', async () => {
        ...
        it('should set the default role permissions for the admin role', async () => {
          it('should throw an UnauthorizedException when the user being updated is the owner of the organisation', async () => {});
          it('should return a dto with the updated member data', async () => {});
        });
      });

      it('should set default role permissions when some or all role permissions are provided', async () => {
        it('should rethrow the error generated by the Supabase client when fetching org member data', async () => {});
        it('should set the provided role permissions for the member role', async () => {
          it('should throw an UnauthorizedException when the user being updated is the owner of the organisation', async () => {});
          it('should return a dto with the updated member data', async () => {});
        });
        it('should set the provided role permissions for the admin role', async () => {
          it('should throw an UnauthorizedException when the user being updated is the owner of the organisation', async () => {});
          it('should return a dto with the updated member data', async () => {});
        });
      });
