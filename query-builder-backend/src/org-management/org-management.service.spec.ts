...
describe('OrgManagementService', () => {
  ...
  describe('updateMember', () => {
    ...
    describe('updateMember_H1', () => {
      ...
      describe('should set default role permissions when no role permissions are provided', async () => {
        ...
        describe('should set the default role permissions for the member role', async () => {
        ...
        describe('should set the default role permissions for the admin role', async () => {
          it('should throw an UnauthorizedException when the user being updated is the owner of the organisation', async () => {
            let testError = [];
            let testData = [];
      ...
      describe('should set default role permissions when some or all role permissions are provided', async () => {
        it('should rethrow the error generated by the Supabase client when fetching org member data', async () => {
          let testError = [];
          testError[SELECT] = { message: 'Internal Server Error', status: 500 };
