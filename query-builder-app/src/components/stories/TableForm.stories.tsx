...
export const DefaultTableForm = {
    ...
    render: () => <TableForm database="sakila" language="mysql" databaseServerID="mockServerID" table={tableProp}/> // this function specifies how we want to render this variant of the component
