...
export const DefaultTableList = {
    ...
    render: () => <TableList language="mysql" databaseServerID="mockServerID" databaseName="sakila" table={tableProp}/> // this function specifies how we want to render this variant of the component
